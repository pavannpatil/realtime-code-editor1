...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'scale-up-center': 'scale-up-center 0.4s cubic-bezier(0.175, 0.885, 0.320, 1.275) both',
        'fade-in': 'fade-in 0.4s cubic-bezier(0.190, 1.000, 0.220, 1.000) both',
        'fade-out': 'fade-out 0.4s cubic-bezier(0.190, 1.000, 0.220, 1.000) both',
        'fade-in-top': 'fade-in-top 0.4s cubic-bezier(0.4, 0, 0.2, 1) both',
        'fade-in-bottom': 'fade-in-bottom 0.4s cubic-bezier(0.4, 0, 0.2, 1) both',
