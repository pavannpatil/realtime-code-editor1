...
const showcaseImages: ShowcaseImage[] = [
  {
    ...
    description: 'Code together in real-time with cursor sharing, highlighting, and follow mode',
  ...
  },
  {
    ...
    description: 'Execute code and see results together with over 80 supported languages',
  ...
  },
  {
    ...
    alt: 'Live preview',
    title: 'Live Preview',
    description: 'Preview UI changes instantly with loaded libraries like Tailwind CSS, and more',
  ...
  },
  {
    ...
    description: 'Take notes together in real-time with rich text and markdown support',
...
const ShowcaseCard = ({ image }: { image: ShowcaseImage }) => (
  <div
    className="group relative min-h-[300px] w-full overflow-hidden rounded-lg border-none bg-black/20
      backdrop-blur-sm"
  >
    ...
    <div className="min-h-28 p-4">
      <div className="mb-2 flex items-center gap-2">
        <span className="rounded-full bg-[#f6d84f]/10 p-2 text-[#f6d84f]">{image.icon}</span>
        <h1 className="text-foreground text-base font-semibold tracking-tight">{image.title}</h1>
      </div>
